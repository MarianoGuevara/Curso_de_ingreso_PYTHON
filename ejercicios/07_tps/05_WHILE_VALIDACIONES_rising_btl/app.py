...
class App(customtkinter.CTk):
    ...
    def btn_validar_on_click(self):
        ...
        while True:
            try:
                ...
                if edad < 18 or edad > 91:
                    alert('', 'edad no valida (de 18 a 90)')
                else:
                    break
            except Exception:
        ...
        while True:
            estado_civil = prompt('', 'Ingrese estado civil (Soltero, Casado, Divorciado, Viudo): ')
            if (estado_civil == 'Soltero/a' or estado_civil == 'Casado/a'
                or estado_civil == 'Divorciado/a' or estado_civil == 'Viudo/a'):
                    break

        while True:
            numero_legajo = prompt('', 'Ingrese numero de legajo' 
                                'numérico de 4 cifras, sin ceros a la izquierda.):')

            try:
                numero_legajo = int(numero_legajo)
                if numero_legajo > 999 and numero_legajo < 10000:
                    break
            except:
                alert("", 'numero legajo debe ser numerico')
