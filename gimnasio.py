...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # Lista de edades de las personas (entre 18 y 70 años)
        self.edades = [30, 25, 22, 27, 35, 28, 31, 24, 29, 26, 33, 23, 32, 21, 34]

        # Lista del peso levantado en press de banca (en kilogramos)
        self.press_banca = [80, 65, 70, 55, 95, 60, 100, 45, 85, 75, 90, 70, 75, 50, 110]

        # Lista de géneros de las personas (Masculino, Femenino u Otro)
